...
import { calculateHourFromAMPM, convertDataToISO, getEndOfWeek, getNextDay, getNextMonth, getNextWeek, getNextYear, getPreviousDay, getPreviousMonth, getPreviousWeek, getPreviousYear, getStartOfWeek, } from './utils/manipulation';
...
export class Datetime {
  ...
  renderCalendarViewHeader(mode) {
    ...
    return (h("div", { class: "datetime-header" },
      ...
      mode === 'md' && !this.multiple && (h("div", { class: "datetime-selected-date" }, getMonthAndDay(this.locale, this.activeParts)))));
  }
  /**
